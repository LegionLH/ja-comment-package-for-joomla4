	...
	<br />
		<div id="ServiceComments">
			<div class="box">
				<h2>
					<?php
					echo JText::_('XML_COMMENTS');
					?>
				</h2>
				<div class="box_content">
					<div style="text-align: right;">
						<a id='jac_help' href="index.php" onclick="hiddenNote('import','<?php echo JText::_('TEXT_HELP')?>','<?php echo JText::_('CLOSE_TEXT')?>');return false;"><?php echo JText::_('TEXT_HELP')?></a>
					</div>		
					<?php
					$note = JText::_("IMPORT_NOTE");
					JACommentHelpers::displayNote($note, 'import');
					?>
							...
							<div class="tab_list">
								<ul id="ja-tabs">
									<li>
										<a id="intensedebate"
										<?php
										if ($source == "" || $source == "intensedebate") {
										?>
										class="active" <?php
										}
										?>><?php echo JText::_('INTENSE_DEBATE')?></a>
									</li>
									<li>
										<a id="disqus" <?php
										if ($source == "disqus") {
										...
										?>><?php echo JText::_('DISQUS_COMMENT')?></a>
									</li>
									<li>
										<a id="jacomment" <?php
										if ($source == "jacomment") {
								...
								<div id="ja-tabs-content">
									<div id="page-intensedebate" class="tab">
										<p style="margin-left:0;">
											<?php
											echo JText::_('SELECT_INTENSE_DEBATE_XML_FILE');
											?>
										</p>
										<p style="display: block; margin-left:0;" id="intensedebate_import">
									...
									<div id="page-disqus" class="tab">
										<p style="margin-left:0;">
											<?php
											echo JText::_('SELECT_DISQUS_XML_FILE');
											?>
										</p>
										<p style="display:block; margin-left:0;" id="disqus_import">
											...
											<p style="color: red; display: none;" id="err-select-disqus">
												<?php
												echo JText::_("YOU_MUST_SELECT_DISQUS_XML_FILE");
												?>
											</p>
											<a href="javascript:showFitterLink('show');" id="import-disqus-show"
												style="font-weight: bold; display: none;"
												title="<?php
												echo JText::_("IMPORT_OPTIONS");
												?>">
												<?php echo JText::_("SHOW_IMPORT_OPTIONS"); ?>
											</a>
											<a href="javascript:showFitterLink('hidden');"
												id="import-disqus-hidden" style="font-weight: bold;"
												title="<?php
												echo JText::_("IMPORT_OPTIONS");
												?>">
												<?php echo JText::_("HIDE_IMPORT_OPTIONS"); ?>
											</a>
											<br />
											<div id="fitterLink">
												...
												<p>
													<?php
													echo JText::_("SELECT_SOURCE_COMPONENT");
													?>
												</p>
												...
												<p>
													<?php
													echo JText::_("SELECT_DESTINATION_COMPONENT");
													?>
												</p>
											</div>
									...
									<div id="page-jacomment" class="tab">
										<p style="margin-left:0;"><?php echo JText::_('SELECT_JACOMMENT_XML_FILE'); ?></p>
										<p style="display: block; margin-left:0;" id="jacomment_import">
						...
						<li class="row-0 pd10">
							<div class="tab_list">
								<ul id="ja-tabs-other">
									...
									?>
									<li>
										<a id="<?php echo $OtherCommentSystem['code']; ?>"
											<?php
											if ($found == 1) {
												?> class="active" 
											<?php
											...
											?>>
											<?php echo $OtherCommentSystem['name'];	?>
										</a>
									</li>
									<?php
										}
							...
							<div id="ja-tabs-content-other">                        
								...
								<div id="page-<?php echo $OtherCommentSystem['code']; ?>" class="tab">
									<p>
										<?php
										echo JText::_('IMPORT_FROM') . ' ' . $OtherCommentSystem['name'];
										?><br />
										<?php
										echo JText::_('COMMENTS_QUANTITY') . ' ' . $OtherCommentSystem['total'];
										?>                    
									</p>
									<p style="display: block;" id="<?php echo $OtherCommentSystem['code']; ?>">
										<input type="button" class="btn_add import" name="<?php echo $OtherCommentSystem['code']; ?>"
											value="<?php echo JText::_('IMPORT')?>"
											onclick="javascript:import2('<?php echo $OtherCommentSystem['code']; ?>', '');"
											<?php
											if ($OtherCommentSystem['total'] == 0) {
												echo "disabled";
											}
											?> />
									</p>
