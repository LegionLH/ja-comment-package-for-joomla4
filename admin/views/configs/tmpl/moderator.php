...
$lists=$this->lists;
$lists['filter_order'] = 'f.ordering';
$lists['type'] = isset($lists['type']) ? $lists['type'] : '';
$lists['filter_order_Dir'] = isset($lists['filter_order_Dir']) ? $lists['filter_order_Dir'] : '';
$ordering = $lists['filter_order'];
?>
