				...
				<ul class="ja-list-checkboxs">
					<li>
						<label>	
							...
							<select name="permissions[view]" id="view" onchange="changeViewComment(this.value)" class="inputbox">
					...
					<li>
						<label>    
							...
							<select name="permissions[post]" id="post" onchange="changeStatusComment(this)" class="inputbox">
					...
					<li>
						<label>    
							...
							<select name="permissions[vote]" id="vote" onchange="changeStatusComment(this)" class="inputbox">
						...
						<div style="padding-left:30px;">
							...
							<ul>
								...
								<li>
									...
									<input class="inputbox" onkeypress="return isNumberKey(event)" onkeyup="checkValidKey(this.value,'lag_voting')" maxlength="20" type="text" value="<?php echo $this->params->get('lag_voting', '');?>" id="lag_voting" name="permissions[lag_voting]" <?php if($typeVoting!="3") echo 'disabled="disabled"';?> />(<?php echo JText::_("SECONDS_BETWEEN_VOTES");?>)</label>      
								</li>
							</ul>
						</div>
					</li>
					<li>
						<label>    
							...
							<select name="permissions[report]" id="report" onchange="changeStatusComment(this)" class="inputbox">
						...
						<div>
							<label for="total_to_report_spam" class="child">
								...
								<input class="inputbox" type="text" onkeyup="checkValidKey(this.value,'total_to_report_spam')" value="<?php echo $this->params->get('total_to_report_spam', '10');?>" id="total_to_report_spam" name="permissions[total_to_report_spam]">                                                    
							</label>
						</div>
					</li>
					<li>
						...
						<div style="padding-left:30px;">
							...
							<ul>
								...
								<li>
									...
									<?php echo JText::_("LAG");?>
									<input class="inputbox" onkeypress="return isNumberKey(event)" onkeyup="checkValidKey(this.value,'lag_editing')" type="text" maxlength="20" value="<?php echo $this->params->get('lag_editing', '172800');?>" id="lag_editing" name="permissions[lag_editing]" <?php if($typeEditing!="3") echo 'disabled="disabled"';?> />(<?php echo JText::_("SECONDS_AFTER_NEW_POST_NOT_ALLOW_THE_USER_TO_EDIT_COMMENT");?>)</label>      
								</li>
							</ul>
						</div>
					</li>
