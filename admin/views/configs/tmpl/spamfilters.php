				...
				<ul class="ja-list-checkboxs">
					...
					<li class="row-0">				
						<label for="is_enable_captcha" class="editlinktip hasTip" title="<?php echo JText::_('ENABLE_CAPTCHA_IMAGE_SECURITY' );?>::<?php echo JText::_('ENABLE_CAPTCHAIMAGE_FOR_GUEST_POSTER_NEEDS_TO_TYPE_IN_THE_DISPLAYED_CHARACTER_IN_ORDER_TO_POST_A_NEW_COMMENT' ); ?>">
							<?php $isEnableCaptcha = $this->params->get('is_enable_captcha', 1);?>
					...
					<li class="row-0">
						<label for="is_enable_captcha_user" class="editlinktip hasTip" title="<?php echo JText::_('ENABLE_CAPTCHA_FOR_REGISTERED_USER' );?>::<?php echo JText::_('ENABLE_CAPTCHAIMAGE_FOR_REGISTERED_USER_POSTER_NEEDS_TO_TYPE_IN_THE_DISPLAYED_CHARACTER_IN_ORDER_TO_POST_A_NEW_COMMENT' ); ?>">
							<?php $isEnableCaptchaUser = $this->params->get('is_enable_captcha_user', 1);?>
					...
					<li class="row-1 ja-section-title" style="margin-top: 13px;">
						<h4><?php echo JText::_('TERMS_AND_CONDITIONS')?></h4>
					</li>			
					<li class="row-0">				
					...
					<li class="row-1 ja-section-title" style="margin-top: 13px;">
						<h4><?php echo JText::_('BLOCK_SETTINGS')?></h4>
					</li>
					...
					<li class="row-0">				
						<label for="min_length">
							...
							<input type="text" class="inputbox" onkeypress="return isNumberKey(event, this)" onkeyup="checkValidKey(this.value,'min_length')" maxlength="4" name="spamfilters[min_length]" value="<?php echo $this->params->get('min_length', 10);?>" id="min_length" size="3" onfocus="checkNumberCharacter('min', this)" /> 
						...
						<label for="max_length">					
							<input type="text" class="inputbox" onkeypress="return isNumberKey(event, this)" onkeyup="checkValidKey(this.value,'max_length')" maxlength="4" name="spamfilters[max_length]" value="<?php echo $this->params->get('max_length', 300);?>" id="max_length" size="3" onchange="checkNumberCharacter('max', this)"/> 
						...
						<div class="child clearfix">								
							<textarea name="spamfilters[censored_words]" id="censored_words" cols="50" rows="5" class="inputbox"><?php echo $this->params->get('censored_words');?></textarea>
						</div>	
						...
						<label for="number_of_links">
							<input type="text" class="inputbox" onkeypress="return isNumberKey(event, this)" onkeyup="checkValidKey(this.value,'number_of_links')" maxlength="4" name="spamfilters[number_of_links]" value="<?php echo $this->params->get('number_of_links',5);?>" id="number_of_links" size="3" onchange="checkMaxLink()"/> 
