...
?>			
	<div id="jac-quick-reply" class="clearfix">			
		...
		<div style="clear:both;">		
			<div class="clearfix">								
				<textarea class = 'tinymce' rows="" cols="" id ='newcomment' name='newcomment' style="width: 98%;"></textarea>
				<?php
...
?>
	<form id="formreply" name="formreply" class="wufoo" autocomplete="off" enctype="multipart/form-data" method="post" action="index.php">
		...
		<div>
			<input name="myfile" id="myfile" type="file" size="30"  onblur="changeBackgroundNone(this)"  onchange="startReplyUpload();"  class="field file" tabindex="5" onfocus="changeBackground(this)" />
			...
			<div id="result_upload_reply" style="float:left;"></div>		
...
<div style="width: 100%;" class="lst_btn clearfix">
		<div style="float: right;">
			<input type="button" onclick="cancelReplyComment('<?php echo $this->curentTypeID;?>')" name="cancelComment" class="btn btn_cancel" value="<?php echo JText::_("CANCEL");?>" />
