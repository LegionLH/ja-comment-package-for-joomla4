...
<a href="javascript:void(0);" class="act-smiley" onclick='javascript:jacChangeDisplay("jacSmileys-<?php echo $this->id;?>", "block", "smiley")' title="<?php echo JText::_("ADD_A_SMILEY");?>"><span><?php echo JText::_("ADD_A_SMILEY");?></span></a>