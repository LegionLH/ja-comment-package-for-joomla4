       ...
       <div class="plugin_embed form-actions clearfix">
       	<ul class="jac-wrapper-actions">			        								    
			...
			<?php if($enableCharacterCounter) { ?>
				<li>
				<!-- BEGIN - Add character counter -->
				<?php require_once $helper->jaLoadBlock("comments/charcounter.php"); ?>
				<!-- END - Add character counter -->
				</li>
			<?php } ?>
			...
			<?php if ($enableLocationDetection) { ?>
				...
				<?php require_once $helper->jaLoadBlock("comments/location.php"); ?>
