...
?>
	<div id="jac-post-new-comment">
		<a href="javascript:open_login('<?php echo JText::_("LOGIN_NOW");?>', '<?php echo $ipBrowser; ?>');"><?php echo JText::_("PLEASE_LOGIN_TO_POST_NEW_COMMENT");?></a>	
	</div>
<?php	
}
//show add new form
		...
		<li class="clearfix form-upload" style="display: none;" id="jac-form-upload">
				...
				<div id="jac-upload" class="clearfix">
					...
					<div class="jac-upload-form">
						<input name="myfile" id="myfile" type="file" size="20" <?php if($totalAttachFile <= 0) echo 'disabled="disabled"';?> onchange="startUpload(1);" class="field file" tabindex="7"/>
						<input name="mypost" id="mypost" type="hidden" value="" />
			...
			<div class="jac-expand-form clearfix">
				...
				<div class="form-userdata clearfix">
					...
					<span class="jac-form-guest">
						...
						<label for="guestName"><?php echo JText::_("LABEL_TEXT_NAME");?> <span id="required_1" class="required"><?php echo JText::_("TEXT_REQUIRED");?></span></label>
					...
					<span class="jac-form-guest">
						...
						<label for="guestEmail"><?php echo JText::_("LABEL_TEXT_EMAIL");?> <span id="required_2" class="required"><?php echo JText::_("TEXT_REQUIRED");?></span></label>
					...
					<span class="jac-form-guest">
						<label for="guestWebsite"><?php echo JText::_("LABEL_TEXT_WEBSITE");?></label>
				...
				<?php
				if ($isShowCaptcha || $isEnableEmailSubscription) {
				?>
				<li class="clearfix">
					<?php
					if($isShowCaptcha){
						if (file_exists(JPATH_SITE.DS."components".DS."com_sef".DS."joomsef.php")) {
							$imgURL = JRoute::_("?option=com_jacomment&amp;task=displaycaptchaaddnew&amp;view=comments&amp;tmpl=component");
						}
						else {
							$imgURL = JRoute::_("index.php?option=com_jacomment&amp;task=displaycaptchaaddnew&amp;view=comments&amp;tmpl=component");
						}
					?>
					<!-- BEGIN -  CAPTCHA -->
					<div id="jac-new-captcha">
						<img alt="Captcha Image" alt="<?php echo JText::_("CLICK_HERE_TO_REFRESH_CAPTCHA");?>" title="<?php echo JText::_("CLICK_TO_REFRESH_CAPTCHA");?>" onmousemove="actionjacLoadNewCaptcha('show')" onmouseout="actionjacLoadNewCaptcha()" onclick="jacLoadNewCaptcha(0)" id="jac_image_captcha"  src="<?php echo $imgURL;?>"/>
