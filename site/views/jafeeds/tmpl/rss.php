...
define("TIME_ZONE", "");
require JPATH_COMPONENT . DS . 'helpers' . DS . 'feedcreator.class.php';
 ...
 * 
 * @param string $words String before processing
 * 
 ...
 * Add absolute URL
 * 
 * @param string $html String before adding absolute URL
 * 
 * @return string String after adding absolute URL
 */
 ...
 * 
 * @param string $html String before deleting images
 * 
 * @return string HTML string after deleting images
 */
 ...
 * @param integer $limit  Limit word to trim
 * 
